...
/* LOCAL VARIABLES */
  ...
  char Buf[100], Tmp[100], Channel[10];
  int Ncol, i;
//  float Offset;
  float *LutArray;
...
strcat(UsageHelp," (string)	-ch  	channel name\n");
...
/*******************************************************************/
  ...
  sprintf(FileName, "%s%s%s%s", DirInput, "product_lut_",Channel,".txt");
...
/*******************************************************************/
  ...
  sprintf(FileName, "%s%s%s%s", DirInput, "product_lut_",Channel,".bin");
