...
strcat(UsageHelp," (float) 	-cc1 	Calibration Const HH\n");
strcat(UsageHelp," (float) 	-cc2 	Calibration Const HV\n");
strcat(UsageHelp," (float) 	-cc3 	Calibration Const VH\n");
strcat(UsageHelp," (float) 	-cc4 	Calibration Const VV\n");
strcat(UsageHelp,"\nOptional Parameters:\n");
...
if(argc < 53) {
  ...
  get_commandline_prm(argc,argv,"-cc1",flt_cmd_prm,&CalibrationConst[0],1,UsageHelp);
  get_commandline_prm(argc,argv,"-cc2",flt_cmd_prm,&CalibrationConst[1],1,UsageHelp);
  get_commandline_prm(argc,argv,"-cc3",flt_cmd_prm,&CalibrationConst[2],1,UsageHelp);
  get_commandline_prm(argc,argv,"-cc4",flt_cmd_prm,&CalibrationConst[3],1,UsageHelp);
  ...
  for (lig = 0; lig < NligBlock[Nb]; lig++) {
    ...
    for (col = 0; col < Ncol; col++) {
      for (Np = 0; Np < Npol; Np++) {
        ...
        S_in[Np][lig][2*col] = S_in[Np][lig][2*col] / pow(10.,CalibrationConst[Np] / 20.);
        S_in[Np][lig][2*col+1] = S_in[Np][lig][2*col+1] / pow(10.,CalibrationConst[Np] / 20.);
