...
proc vTclWindow.top530 {base} {
    ...
    wm withdraw $top
    wm focusmodel $top passive
    wm geometry $top 130x297+10+150; update
...
set URL "https://ietr-lab.univ-rennes1.fr/polsarpro-bio/polsarapp_datasets/"
if {$PlatForm == "windows"} {
    eval exec [auto_execok start] $URL
    } else {
    exec xdg-open $URL
    }} \
		-padx 4 -pady 2 -relief ridge -text {Download Datasets} 
    vTcl:DefineAlias "$top.cpd44" "Button579" vTcl:WidgetProc "Toplevel530" 1
    button $top.but67 \
		-background {#ffff00} \
