...
global PSPImportDirInput PSPImportDirOutput
global PSPImportExtractFonction PSPImportOutputFormat PSPSymmetrisation
global NcolFullSize NligFullSize ESARDataFormat ESARpolarType
global MultiLookSubSamp
global OffsetLig OffsetCol FinalNlig FinalNcol 
global ProgressLine
global FileInputHH FileInputHV FileInputVH FileInputVV
...
if {$ESARDataFormat == "dual"} {
    set ExtractFunction "Soft/bin/data_import/esar_convert_dual.exe"
    ...
    TextEditorRunTrace "Process The Function $ExtractFunction" "k"
    TextEditorRunTrace "Arguments: -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -od \x22$PSPImportDirOutput\x22 -odf $PolType -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -pp $ESARpolarType $MultiLookSubSamp" "k"
    set f [ open "| $ExtractFunction -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -od \x22$PSPImportDirOutput\x22 -odf $PolType -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -pp $ESARpolarType $MultiLookSubSamp" r]
    }
if {$ESARDataFormat == "quad"} {
    set ExtractFunction "Soft/bin/data_import/esar_convert.exe"
    if {$ESARDataFormat == "GTC"} { set ExtractFunction "Soft/bin/data_import/esar_convert_gtc.exe" }
    TextEditorRunTrace "Process The Function $ExtractFunction" "k"
...
global PSPImportDirInput PSPImportDirOutput
global PSPImportExtractFonction PSPImportOutputFormat PSPSymmetrisation
global NcolFullSize NligFullSize FSARDataFormat FSARpolarType
global MultiLookSubSamp
global OffsetLig OffsetCol FinalNlig FinalNcol 
global ProgressLine
global FileInputHH FileInputHV FileInputVH FileInputVV
...
if {$FSARDataFormat == "dual"} {
    set ExtractFunction "Soft/bin/data_import/fsar_convert_dual.exe"
    if {$PSPImportOutputFormat == "SPP"} { set PolType "SPP" }
    if {$PSPImportOutputFormat == "IPP"} { set PolType "SPPIPP" }
    if {$PSPImportOutputFormat == "C2"} { set PolType "SPPC2" }
    TextEditorRunTrace "Process The Function $ExtractFunction" "k"
    TextEditorRunTrace "Arguments: -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -msk \x22$FSARMaskFile\x22 -inc \x22$FSARIncAngFile\x22 -od \x22$PSPImportDirOutput\x22 -odf $PolType -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -hdr $FsarHeader -pp $FSARpolarType $MultiLookSubSamp" "k"
    set f [ open "| $ExtractFunction -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -msk \x22$FSARMaskFile\x22 -inc \x22$FSARIncAngFile\x22 -od \x22$PSPImportDirOutput\x22 -odf $PolType -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -hdr $FsarHeader -pp $FSARpolarType $MultiLookSubSamp" r]
    }
...
global RADARSAT2DataFormat RADARSATRCMDataFormat ALOSDataFormat CSKDataFormat CSGDataFormat SAOCOMDataFormat
global TERRASARXDataFormat TERRASARXDataLevel RISATDataFormat
global SENTINEL1DataFormat GF3DataFormat ESARDataFormat FSARDataFormat
...
if {$PSPImportExtractFonction != ""} {
    ...
    if {$ActiveImportData == "RADARSATRCM"} {
...
#############################################################################
## Procedure:  ExtractRADARSATRCM

proc ::ExtractRADARSATRCM {} {
global PSPImportDirInput PSPImportDirOutput
global PSPImportExtractFonction PSPImportOutputFormat PSPSymmetrisation
global NcolFullSize PolarType NligFullSize 
global MultiLookSubSamp
...
global ProgressLine PolarType
global FileInput1 FileInput2 FileInput3 FileInput4 FileInput5 FileInput6
global IEEEFormat RADARSATRCMDataFormat
global RADARSATRCMLutFile1 RADARSATRCMLutFile2 RADARSATRCMLutFile3 RADARSATRCMLutFile4

if {$RADARSATRCMDataFormat == "dual"} {
    set ExtractFunction "Soft/bin/data_import/radarsatrcm_convert_dual.exe"
    if {$PSPImportOutputFormat == "SPP"} { set PolType "SPP" }
    if {$PSPImportOutputFormat == "IPP"} { set PolType "SPPIPP" }
    if {$PSPImportOutputFormat == "C2"} { set PolType "SPPC2" }
    TextEditorRunTrace "Process The Function $ExtractFunction" "k"
    TextEditorRunTrace "Arguments: -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -od \x22$PSPImportDirOutput\x22 -odf $PolType -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -iee $IEEEFormat -pp $PolarType -lt1 \x22$RADARSATRCMLutFile1\x22 -lt2 \x22$RADARSATRCMLutFile2\x22 $MultiLookSubSamp" "k"
    set f [ open "| $ExtractFunction -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -od \x22$PSPImportDirOutput\x22 -odf $PolType -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -iee $IEEEFormat -pp $PolarType -lt1 \x22$RADARSATRCMLutFile1\x22 -lt2 \x22$RADARSATRCMLutFile2\x22 $MultiLookSubSamp" r]
    }
...
if {$RADARSATRCMDataFormat == "quad"} {
    set ExtractFunction "Soft/bin/data_import/radarsatrcm_convert.exe"
    TextEditorRunTrace "Process The Function $ExtractFunction" "k"
    TextEditorRunTrace "Arguments: -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -if3 \x22$FileInput3\x22 -if4 \x22$FileInput4\x22 -od \x22$PSPImportDirOutput\x22 -odf $PSPImportOutputFormat -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -iee $IEEEFormat -sym $PSPSymmetrisation -lt1 \x22$RADARSATRCMLutFile1\x22 -lt2 \x22$RADARSATRCMLutFile2\x22 -lt3 \x22$RADARSATRCMLutFile3\x22 -lt4 \x22$RADARSATRCMLutFile4\x22 $MultiLookSubSamp" "k"
    set f [ open "| $ExtractFunction -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -if3 \x22$FileInput3\x22 -if4 \x22$FileInput4\x22 -od \x22$PSPImportDirOutput\x22 -odf $PSPImportOutputFormat -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -iee $IEEEFormat -sym $PSPSymmetrisation -lt1 \x22$RADARSATRCMLutFile1\x22 -lt2 \x22$RADARSATRCMLutFile2\x22 -lt3 \x22$RADARSATRCMLutFile3\x22 -lt4 \x22$RADARSATRCMLutFile4\x22 $MultiLookSubSamp" r]
    }

PsPprogressBar $f
}
#############################################################################
## Procedure:  ExtractSAOCOM
...
global ProgressLine PolarType
global FileInput1 FileInput2 FileInput3 FileInput4 FileInput5 FileInput6
global IEEEFormat SAOCOMDataFormat TMPSaocomConfig
...
if [file exists $TMPSaocomConfig] {
    ...
    gets $f SAOCOMHeader
    gets $f SAOCOMPrefix
    gets $f SAOCOMByteOrder
    close $f

    set IEEEFormat -1
    if {$SAOCOMByteOrder == "LITTLEENDIAN"} {
        set IEEEFormat 0
        } else {
        set IEEEFormat 1
        }
    ...
    if {$SAOCOMDataFormat == "dual"} {
        set ExtractFunction "Soft/bin/data_import/saocom_convert_dual.exe"
        if {$PSPImportOutputFormat == "SPP"} { set PolType "SPP" }
        if {$PSPImportOutputFormat == "IPP"} { set PolType "SPPIPP" }
        if {$PSPImportOutputFormat == "C2"} { set PolType "SPPC2" }
        TextEditorRunTrace "Process The Function $ExtractFunction" "k"
        TextEditorRunTrace "Arguments: -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -od \x22$PSPImportDirOutput\x22 -odf $PolType -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -iee $IEEEFormat -pp $PolarType -off $SAOCOMHeader -pre $SAOCOMPrefix $MultiLookSubSamp" "k"
        set f [ open "| $ExtractFunction -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -od \x22$PSPImportDirOutput\x22 -odf $PolType -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -iee $IEEEFormat -pp $PolarType -off $SAOCOMHeader -pre $SAOCOMPrefix $MultiLookSubSamp" r]
        }

    if {$SAOCOMDataFormat == "quad"} {
        set ExtractFunction "Soft/bin/data_import/saocom_convert.exe"
        TextEditorRunTrace "Process The Function $ExtractFunction" "k"
        TextEditorRunTrace "Arguments: -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -if3 \x22$FileInput3\x22 -if4 \x22$FileInput4\x22 -od \x22$PSPImportDirOutput\x22 -odf $PSPImportOutputFormat -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -iee $IEEEFormat -sym $PSPSymmetrisation -off $SAOCOMHeader -pre $SAOCOMPrefix $MultiLookSubSamp" "k"
        set f [ open "| $ExtractFunction -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -if3 \x22$FileInput3\x22 -if4 \x22$FileInput4\x22 -od \x22$PSPImportDirOutput\x22 -odf $PSPImportOutputFormat -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -iee $IEEEFormat -sym $PSPSymmetrisation -off $SAOCOMHeader -pre $SAOCOMPrefix $MultiLookSubSamp" r]
        }
...
global ProgressLine PolarType
global FileInput1 FileInput2 FileInput3 FileInput4 FileInput5 FileInput6
global IEEEFormat CSGDataFormat

if {$CSGDataFormat == "dual"} {
    set ExtractFunction "Soft/bin/data_import/csg_convert_dual.exe"
    if {$PSPImportOutputFormat == "SPP"} { set PolType "SPP" }
    if {$PSPImportOutputFormat == "IPP"} { set PolType "SPPIPP" }
    if {$PSPImportOutputFormat == "C2"} { set PolType "SPPC2" }
    TextEditorRunTrace "Process The Function $ExtractFunction" "k"
...
if {$CSGDataFormat == "quad"} {
    set ExtractFunction "Soft/bin/data_import/csg_convert.exe"
    TextEditorRunTrace "Process The Function $ExtractFunction" "k"
    TextEditorRunTrace "Arguments: -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -if3 \x22$FileInput3\x22 -if4 \x22$FileInput4\x22 -od \x22$PSPImportDirOutput\x22 -odf $PSPImportOutputFormat -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -sym $PSPSymmetrisation -iee $IEEEFormat $MultiLookSubSamp" "k"
    set f [ open "| $ExtractFunction -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -if3 \x22$FileInput3\x22 -if4 \x22$FileInput4\x22 -od \x22$PSPImportDirOutput\x22 -odf $PSPImportOutputFormat -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -sym $PSPSymmetrisation -iee $IEEEFormat $MultiLookSubSamp" r]
    }
...
global ProgressLine PolarType
global FileInput1 FileInput2 FileInput3 FileInput4 FileInput5 FileInput6
global IEEEFormat GF3DataFormat
global GF3QualifyValueHH GF3QualifyValueHV GF3QualifyValueVH GF3QualifyValueVV 
global GF3CalibrationConstHH GF3CalibrationConstHV GF3CalibrationConstVH GF3CalibrationConstVV

if {$GF3DataFormat == "quad"} {
    set ExtractFunction "Soft/bin/data_import/gf3_convert.exe"
    TextEditorRunTrace "Process The Function $ExtractFunction" "k"
    TextEditorRunTrace "Arguments: -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -if3 \x22$FileInput3\x22 -if4 \x22$FileInput4\x22 -od \x22$PSPImportDirOutput\x22 -odf $PSPImportOutputFormat -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -iee $IEEEFormat -sym $PSPSymmetrisation -qv1 $GF3QualifyValueHH -qv2 $GF3QualifyValueHV -qv3 $GF3QualifyValueVH -qv4 $GF3QualifyValueVV -cc1 $GF3CalibrationConstHH -cc2 $GF3CalibrationConstHV -cc3 $GF3CalibrationConstVH -cc4 $GF3CalibrationConstVV $MultiLookSubSamp" "k"
    set f [ open "| $ExtractFunction -if1 \x22$FileInput1\x22 -if2 \x22$FileInput2\x22 -if3 \x22$FileInput3\x22 -if4 \x22$FileInput4\x22 -od \x22$PSPImportDirOutput\x22 -odf $PSPImportOutputFormat -nr $NligFullSize -nc $NcolFullSize -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -iee $IEEEFormat -sym $PSPSymmetrisation -qv1 $GF3QualifyValueHH -qv2 $GF3QualifyValueHV -qv3 $GF3QualifyValueVH -qv4 $GF3QualifyValueVV -cc1 $GF3CalibrationConstHH -cc2 $GF3CalibrationConstHV -cc3 $GF3CalibrationConstVH -cc4 $GF3CalibrationConstVV $MultiLookSubSamp" r]
    }
...
global RADARSAT2DataFormat RADARSATRCMDataFormat SIRCDataFormat ALOSDataFormat CSKDataFormat CSGDataFormat SAOCOMDataFormat
...
if {$ActiveImportData == "CSG"} {
    if {$CSGDataFormat == "quad"} {  set config "true" }
    }
if {$ActiveImportData == "GF3"} {
...
if {$ActiveImportData == "RADARSATRCM"} {
    if {$RADARSATRCMDataFormat == "quad"} {  set config "true" }
    }
if {$ActiveImportData == "SAOCOM"} {
    if {$SAOCOMDataFormat == "quad"} {  set config "true" }
    }
if {$ActiveImportData == "TERRASARX"} {
...
if {$ActiveImportData == "ESAR"} {
    if {$ESARDataFormat == "quad"} {  set config "true" }
    }
if {$ActiveImportData == "FSAR"} {
    if {$FSARDataFormat == "quad"} {  set config "true" }
    }
if {$ActiveImportData == "PISAR"} {
...
global FileInput1 FileInput2 FileInput3 FileInput4 FileInput5 FileInput6 FileInput7 FileInput8
global FileInput9 FileInput10 FileInput11 FileInput12 FileInput13 FileInput14 FileInput15 FileInput16
global AirsarHeader EsarHeader ESARDataFormat UAVSARDataFormat
global FSARMaskFile FSARIncAngFile FSARDataFormat FsarHeader 
global PISARDataFormat EMISARDataFormat CSKDataFormat CSGDataFormat SIRCDataFormat ALOSDataFormat
...
if {$PSPImportOutputSubDir != ""} {append PSPImportDirOutput "/$PSPImportOutputSubDir"}
    ...
    if {"$VarWarning"=="ok"} {
        ...
        if {$TestVarError == "ok"} {
            ...
            if {$ActiveImportData == "CSG"} { ExtractCSG } 
            if {$ActiveImportData == "GF3"} { ExtractGF3 } 
            if {$ActiveImportData == "RADARSAT2"} { ExtractRADARSAT2 } 
            if {$ActiveImportData == "RADARSATRCM"} { ExtractRADARSATRCM } 
            if {$ActiveImportData == "RISAT"} { ExtractRISAT } 
            if {$ActiveImportData == "SAOCOM"} { ExtractSAOCOM } 
