...
global ColorMapCameron VarColorMap OpenDirFile TMPMemoryAllocError PSPViewGimpBMP
...
if {"$VarWarning"=="ok"} {
    ...
    if {$TestVarError == "ok"} {
        ...
        if [file exists "$CameronDirOutput/Cameron.bmp"] {
            if {$PSPViewGimpBMP != 0} { GimpMapAlgebra "$CameronDirOutput/Cameron.bmp" }
            }
        }
    } else {
