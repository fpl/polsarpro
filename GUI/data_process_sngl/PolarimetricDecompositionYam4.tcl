    ...
    if {"$VarWarning"=="ok"} {
        ...
        if {"$DecompFonction"=="Singh6"} {
            ...
            if {$DecompYam4Final == "i6SD"} {
                ...
                if [file exists "$DecompDirOutput/Singh_i6SD_red.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_i6SD_red.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_i6SD_green.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_i6SD_green.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_i6SD_blue.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_i6SD_blue.bin" $FinalNlig $FinalNcol 4}
                } 
            }           
        if {"$DecompFonction"=="Singh7"} {
            set Fonction2 "of the Singh Decomposition"
            set ProgressLine "0"
            WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
            update
            TextEditorRunTrace "Process The Function Soft/bin/data_process_sngl/singh_7components_decomposition.exe" "k"
            TextEditorRunTrace "Arguments: -id \x22$DecompDirInput\x22 -od \x22$DecompDirOutput\x22 -iodf $DecompDecompositionFonction -nwr $NwinDecompL -nwc $NwinDecompC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/bin/data_process_sngl/singh_7components_decomposition.exe -id \x22$DecompDirInput\x22 -od \x22$DecompDirOutput\x22 -iodf $DecompDecompositionFonction -nwr $NwinDecompL -nwc $NwinDecompC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
            TextEditorRunTrace "Check RunTime Errors" "r"
            CheckRunTimeError
            WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
            if {$DecompYam4Final == "7SD"} {
                if [file exists "$DecompDirOutput/Singh_7SD_Odd.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_7SD_Odd.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_7SD_Dbl.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_7SD_Dbl.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_7SD_Vol.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_7SD_Vol.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_7SD_Hlx.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_7SD_Hlx.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_7SD_OD.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_7SD_OD.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_7SD_CD.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_7SD_CD.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_7SD_MD.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_7SD_MD.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_7SD_red.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_7SD_red.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_7SD_green.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_7SD_green.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_7SD_blue.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_7SD_blue.bin" $FinalNlig $FinalNcol 4}
                } 
            }           
...
if {"$RGBPolarDecomp"=="1"} {
    if {"$VarWarning"=="ok"} {
        ...
        if {$DecompYam4Final == "7SD"} {
            set FileInputBlue "$DecompDirOutput/Singh_7SD_Odd.bin"
            set FileInputGreen "$DecompDirOutput/Singh_7SD_Vol.bin"
            set FileInputRed "$DecompDirOutput/Singh_7SD_Dbl.bin"
            set RGBFileOutput "$DecompDirOutput/Singh_7SD_RGB.bmp"
            }
...
if {"$RGBPolarDecomp"=="1"} {
    if {"$VarWarning"=="ok"} {
        ...
        set FileInputGreen "$DecompDirOutput/Singh_i6SD_Vol.bin"
        set FileInputRed "$DecompDirOutput/Singh_i6SD_Dbl.bin"
        set RGBFileOutput "$DecompDirOutput/Singh_i6SD_DblVolOdd_RGB.bmp"
        set Fonction2 "$RGBFileOutput"    
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
        update
        ...
        set RGBFileOutput "$DecompDirOutput/Singh_i6SD_HlxODCD_RGB.bmp"
        set Fonction2 "$RGBFileOutput"    
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
        update
        ...
        set FileInputBlue "$DecompDirOutput/Singh_i6SD_blue.bin"
        set FileInputGreen "$DecompDirOutput/Singh_i6SD_green.bin"
        set FileInputRed "$DecompDirOutput/Singh_i6SD_red.bin"
        set RGBFileOutput "$DecompDirOutput/Singh_i6SD_RedGreenBlue_RGB.bmp"
        set Fonction2 "$RGBFileOutput"    
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
        update
...
if {"$BMPPolarDecomp"=="1"} {
    if {"$VarWarning"=="ok"} {
        ...
        if {$DecompYam4Final == "7SD"} {
            set BMPFileInput "$DecompDirOutput/Singh_7SD_Odd.bin"
            set BMPFileOutput "$DecompDirOutput/Singh_7SD_Odd_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Singh_7SD_Dbl.bin"
            set BMPFileOutput "$DecompDirOutput/Singh_7SD_Dbl_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Singh_7SD_Vol.bin"
            set BMPFileOutput "$DecompDirOutput/Singh_7SD_Vol_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Singh_7SD_Hlx.bin"
            set BMPFileOutput "$DecompDirOutput/Singh_7SD_Hlx_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Singh_7SD_OD.bin"
            set BMPFileOutput "$DecompDirOutput/Singh_7SD_OD_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Singh_7SD_CD.bin"
            set BMPFileOutput "$DecompDirOutput/Singh_7SD_CD_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Singh_7SD_MD.bin"
            set BMPFileOutput "$DecompDirOutput/Singh_7SD_MD_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            }
...
if {"$CIEPolarDecomp"=="1"} {
    if {"$VarWarning"=="ok"} {
        ...
        if {$DecompYam4Final == "7SD"} {
            set FileInputOdd "$DecompDirOutput/Singh_7SD_Odd.bin"
            set FileInputVol "$DecompDirOutput/Singh_7SD_Vol.bin"
            set FileInputDbl "$DecompDirOutput/Singh_7SD_Dbl.bin"
            set FileInputHlx "$DecompDirOutput/Singh_7SD_Hlx.bin"
            set RGBFileOutput "$DecompDirOutput/Singh_7SD_CIE-Lab.bmp"
            }
...
#############################################################################
## Procedure:  DecompSingh7RGB

proc ::DecompSingh7RGB {} {
global DecompDirInput DecompDirOutput
global DecompDecompositionFonction DecompFonction
global RGBPolarDecomp TMPDecompDir TMPMemoryAllocError DecompYam4Final
global TestVarError TestVarName TestVarType TestVarValue TestVarMin TestVarMax
...
if {"$RGBPolarDecomp"=="1"} {
    if {"$VarWarning"=="ok"} {
        ...
        set FileInputGreen "$DecompDirOutput/Singh_7SD_Vol.bin"
        set FileInputRed "$DecompDirOutput/Singh_7SD_Dbl.bin"
        set RGBFileOutput "$DecompDirOutput/Singh_7SD_DblVolOdd_RGB.bmp"
        set Fonction2 "$RGBFileOutput"    
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
        update
        ...
        set FileInputBlue "$DecompDirOutput/Singh_7SD_CD.bin"
        set FileInputGreen "$DecompDirOutput/Singh_7SD_OD.bin"
        set FileInputRed "$DecompDirOutput/Singh_7SD_MD.bin"
        set RGBFileOutput "$DecompDirOutput/Singh_7SD_MDODCD_RGB.bmp"
        set Fonction2 "$RGBFileOutput"    
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
        update
        ...
        set FileInputBlue "$DecompDirOutput/Singh_7SD_blue.bin"
        set FileInputGreen "$DecompDirOutput/Singh_7SD_green.bin"
        set FileInputRed "$DecompDirOutput/Singh_7SD_red.bin"
        set RGBFileOutput "$DecompDirOutput/Singh_7SD_RedGreenBlue_RGB.bmp"
        set Fonction2 "$RGBFileOutput"    
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
        update
...
proc vTclWindow.top426 {base} {
    ...
    wm withdraw $top
    wm focusmodel $top passive
    wm geometry $top 500x562+10+110; update
...
set DecompYam4Final "i6SD"} \
    ...
    pack $site_5_0.rad69 \
		-in $site_5_0 -anchor center -expand 0 -fill none -side left 
    frame $site_4_0.cpd44 \
		-height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd44" "Frame22" vTcl:WidgetProc "Toplevel426" 1
    set site_5_0 $site_4_0.cpd44
    radiobutton $site_5_0.rad69 \
		\
		-command {global DecompDirOutput DecompDirOutputTmp DecompOutputDir
...
set DecompVolume 0
set DecompYam4Final "7SD"} \
		-text {Seven Component Decomposition ( 7SD )} -value 7SD \
		-variable DecompYam4 
    vTcl:DefineAlias "$site_5_0.rad69" "Radiobutton426_6" vTcl:WidgetProc "Toplevel426" 1
    pack $site_5_0.rad69 \
		-in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.cpd70 \
		-in $site_4_0 -anchor center -expand 0 -fill x -side top 
...
#        set DecompOutputDir $DecompDirOutput
    ...
    checkbutton $site_6_0.che78 \
		-foreground {#0000ff} -text TgtG -variable RGBPolarDecomp 
...
set MaxBMPDecomp "Auto"
    ...
    set MaxBMPDecomp "?"
		...
		-text auto -variable MinMaxBMPDecomp 
